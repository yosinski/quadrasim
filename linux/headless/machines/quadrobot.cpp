...
void Quadrobot::init(QuadroParams* params /* =NULL */ )
{
	...
	m_outerAngleMin=servoToAngle(30); // updated by Sean Lee 7/21/12
	m_outerAngleMax=servoToAngle(680); // updated by Sean Lee 7/21/12
	m_coreAngleMin=servoToAngle(512-120);// updated by Sean Lee 7/21/12
	m_coreAngleMax=servoToAngle(512+120);// updated by Sean Lee 7/21/12
    ...
    //    m_jointLimitAngles.push_back(m_diagAngleThresh);
