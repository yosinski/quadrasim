...
X2Industrial2::X2Industrial2(X2Industrial2Params* params/* =NULL */)
{
	...
	lastPart=createBase(NULL,createTfm(0,0,0),true); //base
	...
	curPart=createCylinderCore(lastPart->act,createTfm(0,m_coreOffset,0,PI/2,0,getInitAngle(jointNo)),false);
	...
	lastPart=createCylinderCore(lastPart->act,createTfm(0,0,-m_coreOffset,-PI/2,0,0),true); //core 1
	createLid(lastPart->act,createTfm(0,0,-m_lidOffset,0,PI/2,0),true); //lid core 1
	createLid(lastPart->act,createTfm(0,0,m_lidOffset,0,-PI/2,0),true); //lid core 1
	createEncoderBox(lastPart->act,createTfm(m_encBoxOffset,0,0,PI,0,0),true); //encoder box core 1
